...
$(".user-info").on("click", function(){$("#users").hide();
  ...
  $( ".user-account-settingss" ).slideToggle( "fast");
    ...
    // let day = document.getElementById('Sage_Day')
    // for (let i = 1; i <= 31; i++) {
    //     let option_day = document.createElement('option')
    //     option_day.value = option_day.text = i
    //     day.add(option_day)
    // }

    // // registration select Year 

    // let year = document.getElementById('Sage_Year')
    // let newyear = new Date().getFullYear()
    // for (let i = newyear; i >= 1920; i--) {
    //     let option_year = document.createElement('option')
    //     option_year.value = option_year.text = i
    //     year.add(option_year)
    // }
